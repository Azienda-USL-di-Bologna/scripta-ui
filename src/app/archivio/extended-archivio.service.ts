...
export class ExtendedArchivioService extends ArchivioService {
   ...
   */
  public downloadFrontespizioFascicolo(
    archivio: Archivio | ArchivioDetail
  ): Observable<any> {
    const url =
      getInternautaUrl(BaseUrlType.Scripta) +
      `/downloadFrontespizioFascicolo/${archivio.id}`;
   ...
   * @returns Il file zip.
   */
  public downloadArchivioZip(
    archivio: Archivio | ArchivioDetail
  ): Observable<any> {
    const url =
      getInternautaUrl(BaseUrlType.Scripta) +
      `/downloadArchivioZip/${archivio.id}`;
  ...
  public updateArchivio<K extends keyof Archivio>(
    archivio: Archivio,
    fields: K[],
    projection?: string,
  ...
  public calcolaPermessiEsplicitiGerarchiaArchivio(idArchivioRadice: number) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) +
      "/" +
      "calcolaPermessiEsplicitiGerarchiaArchivio";
    const formData: FormData = new FormData();
  ...
  public calcolaPermessiEsplicitiArchivio(idArchivio: number) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) +
      "/" +
      "calcolaPermessiEsplicitiArchivio";
    const formData: FormData = new FormData();
  ...
  public uploadDocument(formData: FormData) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "uploadDocument";
    console.log(apiUrl);
    return this._http
      .post(
        apiUrl,
  ...
  public aggiungiArchivioRecente(idArchivioRadice: number) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "aggiungiArchivioRecente";
    const formData: FormData = new FormData();
  ...
  public archivioHasDoc(idArchivio: number): Observable<any> {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "archivioHasDoc";
    const formData: FormData = new FormData();
    formData.append("idArchivio", idArchivio.toString());
  ...
  public deleteArchivio(idArchivio: number) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "deleteArchivio";
    const formData: FormData = new FormData();
    formData.append("idArchivio", idArchivio.toString());
    return this._http.post(apiUrl, formData);
  }

  public spostaArchivio(
    idArchivio: number,
    idArchivioDestinazione: number,
    fascicolo: boolean,
    contenuto: boolean
  ) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "spostaArchivio";
    const formData: FormData = new FormData();
    formData.append("idArchivio", idArchivio.toString());
    formData.append(
      "idArchivioDestinazione",
      idArchivioDestinazione.toString()
    );
  ...
  public copiaArchivio(
    ...
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "copiaArchivio";
    const formData: FormData = new FormData();
    formData.append("idArchivio", idArchivio.toString());
    formData.append(
      "idArchivioDestinazione",
  ...
  public duplicaArchivio(
    idArchivio: number,
    fascicolo: boolean,
    contenuto: boolean
  ) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "duplicaArchivio";
    const formData: FormData = new FormData();
    formData.append("idArchivio", idArchivio.toString());
    formData.append("fascicolo", fascicolo.toString());
    formData.append("contenuto", contenuto.toString());
  ...
  public rendiFascicolo(idArchivio: number) {
    const apiUrl =
      getInternautaUrl(BaseUrlType.Scripta) + "/" + "rendiFascicolo";
    const formData: FormData = new FormData();
    formData.append("idArchivio", idArchivio.toString());
    return this._http.post(apiUrl, formData);
  }
